...
| `preview-pdf.ts` | `bun preview-pdf.ts file.pdf` | Renders PDF pages to PNGs (for showing the patient, or signal-driven inspection); emits page image paths. Needs poppler; without it, present the PDF file directly. |
