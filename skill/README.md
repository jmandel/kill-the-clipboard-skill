...
4. `workflow.md` — Steps 1–10 (DESIGN.md §6) with exact commands and stdout shapes
5. `bundle-rules.md` — PatientSharedBundle / DocumentReference rules (DESIGN.md §5, distilled)
